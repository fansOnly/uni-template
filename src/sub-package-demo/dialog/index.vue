  ...
  <vc-page ref="page" :show="pageReady">
    <view class="page-wrapper">
      ...
      <demo-block title="高级用法" padding>
        <vc-cell title="异步关闭" is-link border @click="visible4 = true"></vc-cell>
        <vc-cell title="API 调用" is-link @click="showMessage"></vc-cell>
      </demo-block>

      <vc-dialog :visible.sync="visible" title="提示弹窗"
        content="流年是一段韶华，苍老是一段年华。当手中以往握紧的风沙扬起，当指尖的沙漏倾泄，当笔墨侧锋浓重，窗外的风景开始变了色彩，瘦黄却凝结成熟，枯零却捎带自然，萧瑟却洋溢温暖。"
        :show-cancel="false" @confirm="onConfirm" @close="onClose"></vc-dialog>
