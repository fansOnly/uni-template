<template>
  <view class="page-wrapper">
    ...
    <vc-action-sheet :visible.sync="visible" :value="value" :data="list" @select="onSelect"
      @close="onClose"></vc-action-sheet>
    <vc-action-sheet :visible.sync="visible2" :value="value2" show-cancel :data="list" @select="onSelect2"
      @cancel="onCancel"></vc-action-sheet>
  ...
  data() {
    return {
      ...
      list2: [
        { title: '选项一', value: '1' },
        { title: '选项二', value: '2' },
        { title: '选项三', value: '3', disabled: true },
      ],
      visible: false,
      visible2: false,
      visible3: false,
