<template>
  <view :class="['et-cell', `et-cell-${size}`, isBorder ? 'et-hairline--bottom' : null, disabled ? 'et-cell--disabled' : null, customClasses]" :style="wrapperStyled" :hover-class="hoverClass" :hover-stay-time="200" @click="onClick">
    ...
    <view class="et-cell__right" :style="rightStyled">
      <view :class="['et-cell__value', textClasses]" :style="textStyled">
...
<style lang="scss" scoped>
  ...
  .et-cell--disabled .et-cell__title,
  .et-cell--disabled .et-cell__value {
    color: $uni-text-color-disabled!important;
    /* #ifdef H5 */
    cursor: not-allowed;
    /* #endif */
  }
  .et-cell--disabled .et-cell__right-icon {
    opacity: .6;
  }
  .et-cell__title {
    text-align: left;
