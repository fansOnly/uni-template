<template>
  <view class="vc-progress" :style="styled">
    <view class="vc-progress__bar" :style="strokeStyled">
      <view class="vc-progress__portion" :style="portionStyled"></view>
...
export default {
  ...
  methods: {
    getProgressWidth() {
      return getRect(this, '.vc-progress').then((rect) => {
        const { width = 0 } = rect
        return width
      })
    },
