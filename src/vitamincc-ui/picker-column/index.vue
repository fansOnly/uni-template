<template>
  <view class="vc-picker-column" @touchstart="onTouchStart" @touchmove="onTouchMove" @touchend="onTouchEnd" @touchcancel="onTouchEnd">
    <view class="vc-picker-wrapper" :style="activeStyled">
      <view v-for="(item, index) in options" :key="index" :class="['vc-picker-column-item', 'vc-ellipsis', position === index ? 'is-active' : null]" :style="rowStyled">{{item.text}}</view>
    </view>
  </view>
</template>
