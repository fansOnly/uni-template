<template>
  <view class="page-wrapper">
    <demo-block title="基础用法" padding>
      ...
      <van-action-sheet :show="show1" :actions="action1" @close="toggleActionSheet1" />
    </demo-block>

    <demo-block title="选项状态" padding>
      <van-button type="primary" @click="toggleActionSheet2">弹出菜单</van-button>
      <van-action-sheet :show="show2" :actions="action2" @close="toggleActionSheet2" />
    </demo-block>

    <demo-block title="展示取消按钮" padding>
      <van-button type="primary" @click="toggleActionSheet3">弹出菜单</van-button>
      <van-action-sheet :show="show3" :actions="action1" cancel-text="取消" @close="toggleActionSheet3">
      </van-action-sheet>
    </demo-block>

    <demo-block title="展示描述信息" padding>
      <van-button type="primary" @click="toggleActionSheet4">弹出菜单</van-button>
      <van-action-sheet :show="show4" :actions="action1" description="这是一段描述信息" @close="toggleActionSheet4">
      </van-action-sheet>
    </demo-block>
    ...
    <demo-block title="微信开放能力" padding>
      ...
      <van-action-sheet :show="show6" title="标题" @close="toggleActionSheet6" :actions="action6"
