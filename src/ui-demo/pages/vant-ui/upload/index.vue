<template>
  <view class="page-wrapper">
    <demo-block title="基础用法" padding>
      <van-uploader name="1" :file-list="fileList1" @after-read="afterRead" @delete="onDelete"
    ...
    <demo-block title="文件预览" padding>
      <van-uploader name="2" :file-list="fileList2" multiple @after-read="afterRead" @delete="onDelete"
        @click-preview="clickPreview" />
    </demo-block>

    <demo-block title="隐藏上传按钮" padding>
      <van-uploader name="2" :file-list="fileList2" multiple show-upload="false" @after-read="afterRead"
        @delete="onDelete" @click-preview="clickPreview" />
    </demo-block>

    <demo-block title="上传状态" padding>
      <van-uploader name="8" :file-list="fileList8" multiple max-count="2" @after-read="afterRead" @delete="onDelete"
        @click-preview="clickPreview" />
    </demo-block>
...
export default {
  ...
  methods: {
    ...
    afterRead(event) {
      ...
      this[`fileList${name}`] = this[`fileList${name}`].concat(file)
    },
    oversize() {
