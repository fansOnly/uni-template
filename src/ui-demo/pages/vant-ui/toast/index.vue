<template>
  <view class="page-wrapper">
    ...
    <demo-block title="加载提示" padding>
      <van-button type="primary" @tap="showLoadingToast" class="demo-margin-right">加载提示</van-button>
      <van-button type="primary" @tap="showCustomLoadingToast">自定义加载图标</van-button>
    </demo-block>
