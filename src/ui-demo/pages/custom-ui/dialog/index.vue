<template>
  <view class="page-wrapper">
    ...
    <et-dialog :visible.sync="visible" title="提示弹窗"
      ...
      @confirm="onConfirm" @close="onClose"></et-dialog>

    <et-dialog :visible.sync="visible2" title="提示弹窗"
      content="岁月里的物象，无论怎样的变幻无常，只要秉持一颗不被惊扰的心念，世风无论怎样的摇曳，也会处惊不变，淡定如初。只要心存温润，便不会邂逅岁月的寒凉，总被一抹暖色所浸润。" @confirm="onConfirm"
      @cancel="onCancel" @close="onClose"></et-dialog>

    <et-dialog :visible.sync="visible3" content="月亮不知什么时候悄然隐去，从梦里醒来时候正是午夜，外面已下着小雨。雨滴滴落窗台，溅起点点晶莹的光点。"
      @confirm="onConfirm" @cancel="onCancel" @close="onClose"></et-dialog>

    <et-dialog :visible.sync="visible4" title="异步关闭"
